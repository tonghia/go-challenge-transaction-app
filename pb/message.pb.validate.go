...
// Validate checks the field values on CreateTransaction with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *CreateTransaction) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateTransaction with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreateTransactionMultiError, or nil if none found.
func (m *CreateTransaction) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateTransaction) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateTransactionValidationError{
					field:  "Amount",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return CreateTransactionValidationError{
				field:  "Amount",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CreateTransactionMultiError(errors)
	}

	return nil
}

// CreateTransactionMultiError is an error wrapping multiple validation errors
// returned by CreateTransaction.ValidateAll() if the designated constraints
// aren't met.
type CreateTransactionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateTransactionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateTransactionMultiError) AllErrors() []error { return m }

// CreateTransactionValidationError is the validation error returned by
// CreateTransaction.Validate if the designated constraints aren't met.
type CreateTransactionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateTransactionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateTransactionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateTransactionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateTransactionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateTransactionValidationError) ErrorName() string {
	return "CreateTransactionValidationError"
}

// Error satisfies the builtin error interface
func (e CreateTransactionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateTransaction.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateTransactionValidationError{}
